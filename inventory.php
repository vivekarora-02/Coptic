...
<html>
<head>
	<title>Inventory | Coptic Stationary</title>
	<link rel="icon" href="res/lg.png" sizes="16x16">
	<link rel="stylesheet" type="text/css" href="css/head.css">
	<link rel="stylesheet" type="text/css" href="css/sidebar2.css?version=2">
...
<?php
$results = $mysqli->query("SELECT id,product_code, product_name, brand, category, price, product_qty FROM products  ORDER BY id ASC");
if($results){ 
$products_item = '<table border="1" bordercolor="white" style="color:white;"><th>ID</th><th>Product Code</th><th>Category</th><th>Brand</th><th>Product Name</th><th>Price</th><th>Product Quantity</th>
