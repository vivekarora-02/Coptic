...
<div id="logo">
	<a href="category.php">
		<img src="res/up-arrow.png" alt="arrow">
	</a>
</div>
...
<div id="sidebar">
	<ul>
		...
		<td>&nbsp;Color Pencils</td></tr></table></a></li>

		<li><a href="#acc"><table><tr>
		<td>&nbsp;Paints</td></tr></table></a></li>

		<li><a href="#sou"><table><tr>
		<td>&nbsp;Highlighters</td></tr></table></a></li>
...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="hf.php">Colors</a></li>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Colorpencils' AND category='Colors' ORDER BY id ASC");
if($results){
...
$products_item .= <<<EOT
	...
	<img src="res/hf/{$obj->product_img_name}">
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Paints' AND category='Colors' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Highlighters' AND category='Colors' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
