...
<div id="sidebar">
	<ul>
		...
		<td>&nbsp;Clips and Staplers</td></tr></table></a></li>

		<li><a href="#acc"><table><tr>
		<td>&nbsp;Scissors and Tapes</td></tr></table></a></li>

		<li><a href="#sou"><table><tr>
		<td>&nbsp;Rulers and PunchMachines</td></tr></table></a></li>
...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="tool.php">Tools</a></li>
...
<h3>CLIPS AND STAPLERS</h3>
<div class="row" id="clothing">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Clips and Staplers' AND category='Tools' ORDER BY id ASC");
if($results){
...
$products_item .= <<<EOT
	...
	<img src="res/tools/{$obj->product_img_name}">
...
<h3>SCISSORS AND TAPES</h3>
<div class="row" id="acc">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Scissors and Tapes' AND category='Tools' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<h3>RULERS AND PUNCHMACHINES</h3>
<div class="row" id="sou">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Rulers and PunchMachines' AND category='Tools' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
