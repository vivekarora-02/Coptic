...
<html>
<head>
	<title>Accessories| COPTIC STATIONARY</title>
...
<div id="sidebar">
	<ul>
		...
		<td>&nbsp;Erasers and Sharpners</td></tr></table></a></li>

		<li><a href="#acc"><table><tr>
		<td>&nbsp;Files and Folders</td></tr></table></a></li>

		<li><a href="#sou"><table><tr>
		<td>&nbsp;Glue and CorrectingPens</td></tr></table></a></li>
...
if(isset($_SESSION["cart_products"]) && count($_SESSION["cart_products"])>0)
{
	...
	echo '<thead><tr><th>Quantity</th><th></th><th>Name</th><th>Remove</th></tr></thead>';
...
<h3>ERASERS AND SHARPNERS</h3>
<div class="row" id="clothing">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Erasers and Sharpners' AND category='Accessories' ORDER BY id ASC");
if($results){
...
$products_item .= <<<EOT
	...
	<img src="res/accessories/{$obj->product_img_name}">
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Files and Folders' AND category='Accessories' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<h3>GLUE AND CORRECTINGPENS</h3>
<div class="row" id="sou">
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Glue and CorrectingPens' AND category='Accessories' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
