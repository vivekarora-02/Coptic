...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='clothing' AND category='Game of Thrones' ORDER BY id ASC");
if($results){ 
