...
<div id="logo">
	<a href="category.php">
		<img src="res/up-arrow.png" height="auto">
	</a>
</div>
...
<div id="sidebar">
	<ul>
		...
		<td>&nbsp;Reynolds</td></tr></table></a></li>

		<li><a href="#acc"><table><tr>
		<td>&nbsp;Parker</td></tr></table></a></li>

		<li><a href="#sou"><table><tr>
		<td>&nbsp;Pilot</td></tr></table></a></li>
...
<div id="navbar">
	<ul>
		...
		<li><a class="active" href="hp.php">Pens</a></li>
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Reynolds' AND category='Pens' ORDER BY id ASC");
if($results){
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Parker' AND category='Pens' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<?php
$results = $mysqli->query("SELECT product_code, product_name, product_img_name, price FROM products WHERE brand='Pilot' AND category='Pens' ORDER BY id ASC");
if($results){
$products_item = '<ul style="list-style-type: none;">';
//fetch results set as object and output HTML
...
<footer class="container">
	<div class="row">
		<p class="col-sm-6">
			&copy; 2021 COPTIC STATIONARY | Made with<i style="color: #fd4b4b;">&nbsp; &#9829; &nbsp;</i>in India
		</p>
	</div>
</footer>
 -->
